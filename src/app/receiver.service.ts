...
export class ReceiverService {
  ...
  private setFalseApi = 'http://localhost:3000/donor/setReceiverFalse';
  ...
  falseReceiver(latestReceiever: any): Observable<any> {
    console.log('jnkjgfzndk', latestReceiever);
    return this.http.put(`${this.setFalseApi}`, { latestReceiever });
  }
